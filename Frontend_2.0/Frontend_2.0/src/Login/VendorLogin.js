...
function VendorLogin() {
    ...
    function handleSubmit(e){
        ...
        axios.post("http://localhost:8080/login/vendor", user, { headers : {
            'Content-Type' : 'application/json' 
        }})
        .then(response=> {
            if(response.status === 200){
                localStorage.setItem("authVendor" ,JSON.stringify(response.data.vendor))
          ...
          >
            ...
            <div>
              ...
              <Grid container spacing={2}>
                <Grid item xs>
                    <div>
                    <Button variant="outlined" href="/reg/vendor">
                       Create Account
                    </Button>
                    </div>            
                </Grid>
                <Grid item>
                <div>
                     <Button variant="outlined" href="/login/customer">
                         Are you a Customer ?
                    </Button>
                </div>
                </Grid>
